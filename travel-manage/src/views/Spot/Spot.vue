<template>
  <el-card class="inf">
    <el-row type="flex" justify="space-between">
      <el-col>
        <el-form :inline="true" :model="formInline">
          ...
          <el-form-item>
            <el-button type="primary" @click="getinfList"  :size="size" :disabled="filterVal === ''">搜索</el-button>
          </el-form-item>
        </el-form>
      </el-col>
      <el-col :span="7">
    ...
    <inf-modal ref="infModal" @getinfList="getinfList"></inf-modal>
  </el-card>
</template>
<script>
  import moment from 'moment'
  import request from '../../api/index.js'
  import infModal from './components/infModal.vue'
  export default {
    // 组件名
    name: 'inf',
    components: {
    ...
    methods: {
      ...
      add(){
        // 父组件直接修改子组件的值
        this.$refs.infModal.ifShowModal = true
        this.$refs.infModal.add()
      },
      // 多选
      ...
      handleEdit(infObj){
        this.$refs.infModal.ifShowModal = true
        this.$refs.infModal.edit(infObj)
      },
      handleDelete(infObj){
        /* 做单选删除: 
